"""Combine the corrected red elephant howdah with its retained named pedestal.
...
body_path = ROOT / "assets/generated/meshy/elephant_red/v2/model.glb"
base_path = ROOT / "assets/generated/meshy/elephant_red/v1/model.glb"
output = ROOT / "assets/generated/meshy/elephant_red/assembled/v1"
...
doc = {"asset":{"version":"2.0","generator":"cn-chess local red-elephant body and base assembly"},
...
report = {"piece":"elephant_red","body_source":str(body_path),"body_sha256":hashlib.sha256(body.raw).hexdigest(),
    "base_source":str(base_path),"base_sha256":hashlib.sha256(base.raw).hexdigest(),"body_triangles_preserved":len(bi),
    "body_uniform_scale":scale,"body_translation":translation.tolist(),"base_horizontal_scale":1.0,
    ...
    "visual_review_required":True,"reference_note":"Version 2 corrects the front canopy; version 1 supplies the full pedestal. All version 2 body triangles retained."}
